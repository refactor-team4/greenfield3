    ...
    <main>
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="row item" v-for="(item, index) in this.events" :key="index">
                ...
                <div class="item-grid">
                 <img
                  ...
                  <div class="item-desc">
                    <div class="item-info">
                      <span class="icon-hard"></span>
                      <h4 class="title"><a href="#">{{item.eventName}}</a></h4>
                    </div>
                    ...
                    <div class="item-detail">
                      <div class="left">
                        <div class="day">
                          <span class="icon-sun"></span>{{ item.date }}
                        </div>
                      </div>
                      <div class="right">
                ...
                <div class="item-grid">
                  ...
                  <div class="item-desc">
                    ...
                    <div class="item-detail">
                      <div class="left">
                        <div class="day">
                          <span class="icon-sun"></span>3 Days
                        </div>
                        <div class="night">
                          <span class="icon-moon"></span>2 Nights
                        </div>
                      </div>
                      <div class="right">
