...
<button id='toggleBtn' v-on:click="openPostForm" type="button" class="btn btn-success">POST STORY</button>
<form v-if="Post" class="form-horizontal">
<fieldset>
<div class="form-group">
  <label  class="col-md-4 control-label" for="event_name">Name</label>
  <div class="col-md-4">
  <input id="event_name" name="event_name" type="text" placeholder="Post Name.." class="form-control input-md">
  </div>
</div>
<div class="form-group">
  <label  class="col-md-4 control-label" for="event_name">Place</label>
  <div class="col-md-4">
  <input id="event_name" name="event_name" type="text" placeholder="Camping place.." class="form-control input-md">
  </div>
</div>
<div class="form-group">
  <label  class="col-md-4 control-label" for="event_name">Picture</label>
  <div class="col-md-4">
  <input id="event_name" name="event_name" type="file" placeholder="Picture" class="form-control input-md">
  </div>
</div>
<div class="form-group">
...
<button id="PostBtn" type="button" class="btn btn-success">POST</button>
                        ...
                        <div class="post-summary">
                            ...
                            <div class="post-excerpt">
                                ...
                                adipisicing elit. Ratione cupiditate, expedita
                                maxime voluptate iste eius fuga amet voluptas,
                                unde exercitationem itaque praesentium velit
                                facilis totam?
                            </div>
                            <a
...
export default {
  ...
  comments: [],
    ...
    axios.post('/Feed/postBlog', post).then((response)=>{
